...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)('$getGlobalValue', true);
        this.description = 'Get a global runtime variable.';
        this.params = [
            {
                name: 'Name',
    ...
    resolve({ inside = '' }) {
        ...
        return new Nodes_1.CallNode({
            callee: new Nodes_1.LiteralNode('runtime.globals.get'),

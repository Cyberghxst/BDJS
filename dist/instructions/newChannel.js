...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)(/\$new(Channel|Thread)/, true);
        this.description = 'Retrieves a new channel data.';
        this.params = [
            {
                name: 'Property',
    ...
    resolve({ inside = '' }) {
        ...
        return new Nodes_1.OperatorNode({
            elements: [
                new Nodes_1.LiteralNode('runtime.states.channel.new'),

...
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)('$oldAutomodRule', true);
        this.description = 'Retrieves an old automod rule data.';
        this.params = [
            {
                name: 'Property',
    ...
    resolve({ inside = '' }) {
        ...
        return new Nodes_1.OperatorNode({
            elements: [
                new Nodes_1.LiteralNode('runtime.states.automod.old'),

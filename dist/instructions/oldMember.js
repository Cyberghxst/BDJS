...
/**
 * @name $oldMember
 * @description Retrieves an old member data.
 * @returns {string}
 */
class default_1 extends BaseInstruction_1.BaseInstruction {
    constructor() {
        super(...arguments);
        this.patterns = (0, makePattern_1.default)('$oldMember', true);
        this.description = 'Retrieves an old member data.';
        this.params = [
            {
                name: 'Property',
    ...
    resolve({ inside = '' }) {
        ...
        return new Nodes_1.OperatorNode({
            elements: [
                new Nodes_1.LiteralNode('runtime.states.member.old'),
